...
{
	if (region.cN.bb === region.c9.bb)
	{
		return 'on line ' + region.cN.bb;
	}
	return 'on lines ' + region.cN.bb + ' through ' + region.c9.bb;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eH: 'hidden', eq: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eH: 'mozHidden', eq: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eH: 'msHidden', eq: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eH: 'webkitHidden', eq: 'webkitvisibilitychange' }
		: { eH: 'hidden', eq: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		eb: {
			ef: _Browser_window.pageXOffset,
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.eC.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done($elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done($elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.eC.b, xhr)); });
		$elm$core$Maybe$isJust(request.d6) && _Http_track(router, xhr, request.d6.a);

		try {
			xhr.open(request.eQ, request.fp, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.fp));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.responseType = request.eC.d;
	xhr.withCredentials = request.ek;
}
...
function _Http_track(router, xhr, tracker)
{
	...
	xhr.addEventListener('progress', function(event) {
		...
		_Scheduler_rawSpawn(A2($elm$core$Platform$sendToSelf, router, _Utils_Tuple2(tracker, $elm$http$Http$Receiving({
			e1: event.loaded,
			d_: event.lengthComputable ? $elm$core$Maybe$Just(event.total) : $elm$core$Maybe$Nothing
		}))));
	});
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {df: fragment, di: host, dG: path, dI: port_, dM: protocol, dN: query};
	});
...
var $author$project$Sudoku$DataReceived = function (a) {
	return {$: 1, a: a};
};
			...
			return $elm$http$Http$Request(
				{
					ek: r.ek,
					en: r.en,
					eC: A2(_Http_mapExpect, func, r.eC),
					dg: r.dg,
					eQ: r.eQ,
					fg: r.fg,
					d6: r.d6,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{ek: false, en: r.en, eC: r.eC, dg: r.dg, eQ: r.eQ, fg: r.fg, d6: r.d6, fp: r.fp}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{en: $elm$http$Http$emptyBody, eC: r.eC, dg: _List_Nil, eQ: 'GET', fg: $elm$core$Maybe$Nothing, d6: $elm$core$Maybe$Nothing, fp: r.fp});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Sudoku$Step = F6(
	function (count, action, transform, stack, score, board) {
		return {bK: action, aH: board, c4: count, dX: score, d1: stack, d8: transform};
	});
var $author$project$Sudoku$Extend = 2;
var $author$project$Sudoku$Fill = 1;
var $author$project$Sudoku$Invalid = 4;
var $author$project$Sudoku$None = 3;
var $author$project$Sudoku$Prune = 0;
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Parser$actionDecoder = A2(
...
var $author$project$Parser$arrayAsTuple3 = F3(
	function (a, b, c) {
		return A2(
			$elm$json$Json$Decode$andThen,
			function (aVal) {
						...
						return A2(
							...
							function (cVal) {
								return $elm$json$Json$Decode$succeed(
									_Utils_Tuple3(aVal, bVal, cVal));
							},
							A2($elm$json$Json$Decode$index, 2, c));
					},
					A2($elm$json$Json$Decode$index, 0, b));
			},
			A2($elm$json$Json$Decode$index, 1, a));
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Parser$boardDecoder = $elm$json$Json$Decode$list(
	A3(
		$author$project$Parser$arrayAsTuple3,
		$elm$json$Json$Decode$int,
		$elm$json$Json$Decode$int,
		$elm$json$Json$Decode$list($elm$json$Json$Decode$int)));
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Sudoku$Boxes = 2;
var $author$project$Sudoku$Cols = 1;
var $author$project$Sudoku$Rows = 0;
var $author$project$Parser$transformDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (s) {
		switch (s) {
			case 'Rows':
			...
			case 'Boxes':
				return $elm$json$Json$Decode$succeed(2);
			default:
				return $elm$json$Json$Decode$fail('Unknown transformation.');
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Parser$stepDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Sudoku$Step,
	A2($elm$json$Json$Decode$field, 'count', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'action', $author$project$Parser$actionDecoder),
	A2($elm$json$Json$Decode$field, 'transform', $author$project$Parser$transformDecoder),
	A2($elm$json$Json$Decode$field, 'stack', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'score', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'board', $author$project$Parser$boardDecoder));
var $author$project$Parser$logDecoder = $elm$json$Json$Decode$list($author$project$Parser$stepDecoder);
var $author$project$Main$url = 'http://localhost:3000/model';
var $author$project$Main$getModel = $elm$http$Http$get(
	{
		eC: A2($elm$http$Http$expectJson, $author$project$Sudoku$DataReceived, $author$project$Parser$logDecoder),
		fp: $author$project$Main$url
	});
...
var $author$project$Main$testB = function () {
	var f = function (n) {
		return A2(
			$elm$core$List$map,
			function (m) {
	...
	var inds = A2(
		...
		f,
		A2($elm$core$List$range, 0, 8));
	var empty = A2($elm$core$List$range, 0, 9);
	var vals = $elm$core$List$concat(
		A2(
	...
	return A3(
		...
		F2(
			function (_v0, v) {
				var myCX = _v0.a;
				var myCY = _v0.b;
				return _Utils_Tuple3(myCX, myCY, v);
			}),
		inds,
		vals);
}();
...
var $author$project$Sudoku$IterKeyPressed = {$: 3};
var $author$project$Sudoku$RevKeyPressed = {$: 2};
var $author$project$Main$toKey = function (keyValue) {
	if (keyValue === 'p') {
		return $author$project$Sudoku$RevKeyPressed;
	} else {
		return $author$project$Sudoku$IterKeyPressed;
	}
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				return _Utils_Tuple2(
					$author$project$Main$revModel(model),
					$elm$core$Platform$Cmd$none);
			default:
				if (!msg.a.$) {
					var log = msg.a.a;
...
var $author$project$Main$box = F2(
	function (myX, myY) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$px(myX)),
...
var $author$project$Main$genLine = F2(
	function (myStroke, _v0) {
		var _v1 = _v0.a;
		var myX1 = _v1.a;
		var myY1 = _v1.b;
		var _v2 = _v0.b;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$px(myX1)),
					$elm_community$typed_svg$TypedSvg$Attributes$x2(
					$elm_community$typed_svg$TypedSvg$Types$px(myX2)),
					$elm_community$typed_svg$TypedSvg$Attributes$y1(
					$elm_community$typed_svg$TypedSvg$Types$px(myY1)),
					$elm_community$typed_svg$TypedSvg$Attributes$y2(
					$elm_community$typed_svg$TypedSvg$Types$px(myY2)),
					$elm_community$typed_svg$TypedSvg$Attributes$strokeWidth(
					$elm_community$typed_svg$TypedSvg$Types$px(myStroke)),
					$elm_community$typed_svg$TypedSvg$Attributes$stroke(
					$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$black))
				]),
			_List_Nil);
	});
var $author$project$Main$genPoints = F3(
	function (myX, myY, ns) {
		return _Utils_ap(
			A2(
				$elm$core$List$map,
				function (n) {
					return _Utils_Tuple2(
						_Utils_Tuple2((myX * n) / 9, 0),
						_Utils_Tuple2((myX * n) / 9, myY));
				},
				ns),
			A2(
				$elm$core$List$map,
				function (n) {
					return _Utils_Tuple2(
						_Utils_Tuple2(0, (myY * n) / 9),
						_Utils_Tuple2(myX, (myY * n) / 9));
				},
				ns));
	});
var $author$project$Main$majorLines = F3(
	function (myX, myY, myStroke) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$genLine(myStroke),
			A3(
				$author$project$Main$genPoints,
				myX,
				myY,
				_List_fromArray(
					[3, 6])));
	});
var $author$project$Main$minorLines = F3(
	function (myX, myY, myStroke) {
		return A2(
			$elm$core$List$map,
			$author$project$Main$genLine(myStroke),
...
var $author$project$Main$expScale = function (n) {
	var x = n;
	var div = (n > 2) ? 2 : 1;
	return ((81 - A2($elm$core$Basics$pow, x, 2)) / 81) / div;
};
...
var $author$project$Main$genCellBG = F4(
	function (myX, myY, a, _v0) {
		var myCXInt = _v0.a;
		var myCYInt = _v0.b;
		var ns = _v0.c;
		var offset = 0.5;
		...
		var _v1 = function () {
			if (a === 4) {
				return _Utils_Tuple2($avh4$elm_color$Color$lightRed, 0.25);
			} else {
				return _Utils_Tuple2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$Paint(bgColor)),
					$elm_community$typed_svg$TypedSvg$Attributes$opacity(
					$elm_community$typed_svg$TypedSvg$Types$Opacity(op))
				]),
			_List_Nil);
	});
var $author$project$Main$populate = F4(
	function (myX, myY, a, cs) {
		return _Utils_ap(
			A2(
				$elm$core$List$map,
				A3($author$project$Main$genCellBG, myX, myY, a),
				cs),
			A2(
				$elm$core$List$map,
...
var $author$project$Main$showBoard = F4(
	function (myX, myY, a, b) {
		return _Utils_ap(
			A3($author$project$Main$minorLines, myX, myY, 0.5),
			_Utils_ap(
				A3($author$project$Main$majorLines, myX, myY, 1.5),
				_Utils_ap(
					A4($author$project$Main$populate, myX, myY, a, b),
					_List_fromArray(
						[
...
var $author$project$Main$showTransform = function (t) {
	switch (t) {
		case 0:
			return 'Rows';
		case 1:
...
var $author$project$Main$showStat = F3(
	function (myX, myY, _v0) {
		var count = _v0.c4;
		var action = _v0.bK;
		var transform = _v0.d8;
		var score = _v0.dX;
		var stack = _v0.d1;
		var stats = _List_fromArray(
			[
				_Utils_Tuple3(
				1,
				'Iter',
				...
				3,
				'Stack',
				$elm$core$String$fromInt(stack)),
				_Utils_Tuple3(
				4,
				'Action',
				$author$project$Main$showAction(action)),
				_Utils_Tuple3(
				5,
				'Transform',
				$author$project$Main$showTransform(transform))
			]);
		var showText = function (_v1) {
			var i = _v1.a;
			var label = _v1.b;
			var s = _v1.c;
			return A2(
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text(label + (': ' + s))
					]));
		};
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{eL: $author$project$Main$init, fd: $author$project$Main$subscriptions, fo: $author$project$Main$update, fq: $author$project$Main$view});
